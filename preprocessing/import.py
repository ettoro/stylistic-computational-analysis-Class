...
# IF YOU ARE WORKING WITH ENGLISH 
spacy_stopwords = spacy.lang.en.stop_words.STOP_WORDS
nlp = en_core_web_sm.load()

# IF YOU ARE WORKING WITH ITALIAN
spacy.cli.download("it_core_news_sm") # necessary if you are working on a jupyter notebook, otherwise you can simply download it 
                                    # with the command: python -m spacy download it_core_news_sm (then import it)
nlp = spacy.load('it_core_news_sm')       

# stopwords list taken from spacy list github.com/explosion/spaCy/blob/master/spacy/lang/it/stop_words.py
STOP_WORDS = set(
    """
